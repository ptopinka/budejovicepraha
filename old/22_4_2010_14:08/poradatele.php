		    ...
		    <div class="bd">
		        <ul class="first-of-type">
		            <li class="yuimenuitem">
		                <a class="yuimenuitemlabel" href="index.php">
		                    uvod
		                </a>
		            </li>
		            <li class="yuimenuitem">
		                <a class="yuimenuitemlabel" href="propozice.php">
		                    Propozice
		                </a>
		            </li>
		            <li class="yuimenuitem">
		                <a class="yuimenuitemlabel" href="etapy.php">
		                    Etapy
		                </a>
		            </li>
		            <li class="yuimenuitem">
		                <a class="yuimenuitemlabel" href="podrobnosti.php">
		                    podrobnosti
		                </a>
		            </li>
		        </ul>            
...
-->
	...
	<div id="center1">
		...
		<p>
			...
			<ul>
				<li>Odvárko Michael &nbsp;+420 776 699 436</li>
				<li>Náprstek Petr   &nbsp;+420 777 336 361</li>
				<li>Odvárko Tomáš   &nbsp;+420 728 952 693</li>
			</ul>
			<b>e-mail:</b> budejovicepraha@gmail.com
		</p>
